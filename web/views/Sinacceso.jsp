<%-- 
    Document   : Sinacceso
    Created on : 04-26-2021, 09:33:11 PM
    Author     : Omar Fer
--%>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <h2>UH OH! No tienes permiso.</h2>
        <p>La página a la que estás intentando acceder necesita autorizacion especial. Presiona el Botón de abajo para regresar a la página  principal.
        </p>
        <button class="btn green"><a href="./index.jsp" style="text-decoration:none;">INICIO</a></button>
      </div>
    </div>
  </div>
</main>
